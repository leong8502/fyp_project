...
from core.views.freelancer import (
    ...
    freelancer_upload_resume,
    freelancer_view_resume,
    freelancer_delete_resume,
    api_request_pin_otp,
    api_verify_pin_otp,
)
...
from core.views.ami import chat_ami, ami_history, ami_quota
